...
@SpringApplicationConfiguration(classes = WelcomeApp.class)
@WebAppConfiguration
@IntegrationTest({"server.port:0",
        "spring.datasource.url:jdbc:h2:mem:my-cb-eclipse;DB_CLOSE_ON_EXIT=FALSE"})*/
...
public class HelloControllerTest {
	 ...
	 * 
	 * @Test public void testHello() throws Exception { when().get("/").then()
	 * .body(is("Hello World!")); }
	 * 
